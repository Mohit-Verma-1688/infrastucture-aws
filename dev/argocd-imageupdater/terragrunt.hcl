...
terraform {
  source = "git::git@github.com:Mohit-Verma-1688/infrastucture-modules.git//argocd-imageupdater?ref=${include.dev.locals.argocd-imageupdater-module}"
}
...
inputs = {
  ...
  enable_argocd-imageup      = include.dev.locals.argocd-imageupdater
  argocd-imageup_helm_verion = include.dev.locals.argocd-imageup_helm_verion
}
